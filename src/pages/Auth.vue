				...
				<div class="form-register-with-email">
					<div class="form-white-background">
						...
						<div
							class="form-row"
							:class="{
								invalid: !registeredData.username.isValid,
							}"
						>
							<label>
								<span>Username</span>
						...
						<div
							class="form-row"
							:class="{
								invalid: !registeredData.email.isValid,
							}"
						>
							<label>
								<span>Email</span>
						...
						<div
							class="form-row"
							:class="{
								invalid: !registeredData.password.isValid,
							}"
						>
							<label>
								<span>Password</span>
				...
				<div class="form-register-with-email">
					<div class="form-white-background">
						...
						<div class="form-row line" v-if="isRedirect">
							<p>
								You've sucessfully registered! Now let's login with your account!
							</p>
						</div>
						...
						<div
							class="form-row"
							:class="{
								invalid: !loginData.email.isValid,
							}"
						>
							<label>
								<span>Email</span>
						...
						<div
							class="form-row"
							:class="{
								invalid: !loginData.password.isValid,
							}"
						>
							<label>
								<span>Password</span>
